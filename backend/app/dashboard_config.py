...
from app.comparison_models import (
    ...
    build_execution_assumptions_definition,
)
...
DEFAULT_INVESTMENT_UNIVERSE = build_investment_universe_definition(
...
DEFAULT_ANNUAL_EXECUTION_POLICY = build_execution_policy_definition(
    key="annual",
    label="年次",
...
DEFAULT_DAILY_EXECUTION_POLICY = build_execution_policy_definition(
    key="daily",
    label="日次",
    entry="train_once_then_periodic_rebalance",
...
REFERENCE_HOLD_EXECUTION_POLICY = build_execution_policy_definition(
    key="hold",
    label="保有",
    entry="hold",
...
DEFAULT_CLOSE_EXECUTION_ASSUMPTIONS = build_execution_assumptions_definition(
    label="終値約定",
    parameters={
        "fillPrice": "close",
    },
...
REALISTIC_DAILY_EXECUTION_ASSUMPTIONS = build_execution_assumptions_definition(
    label="終値約定",
    parameters={
        "fillPrice": "close",
    },
    cost_model_definition=build_multi_asset_daily_cost_model_preset("realistic_v1"),
)
...
REFERENCE_EQUAL_WEIGHT_WITH_CASH = build_strategy_definition(
    ...
    execution_policy_definition=REFERENCE_HOLD_EXECUTION_POLICY,
...
DEFAULT_COMPARISON_CONFIG = ComparisonDefinition(
    ...
    execution_assumptions_definition=DEFAULT_CLOSE_EXECUTION_ASSUMPTIONS,
    ...
    reference_strategy_definitions=[REFERENCE_EQUAL_WEIGHT_WITH_CASH],
