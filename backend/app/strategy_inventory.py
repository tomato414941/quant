...
EXPLICIT_STRATEGY_INVENTORY_ENTRIES = (
    ...
    StrategyInventoryEntry(
        ...
        expected_regimes=("broad_market", "diversification"),
        risk_regimes=("benchmark",),
        tags=("etf_universe", "equal_risk_contribution", "reference_candidate"),
        notes="ETF equal-risk-contribution candidate for portfolio construction comparison.",
    ),
    StrategyInventoryEntry(
        ...
        priority="medium",
        baseline_strategy_id="stg-fu-eq",
        expected_regimes=("defensive_market", "low_volatility"),
        risk_regimes=("benchmark",),
        tags=("etf_universe", "minimum_variance", "reference_candidate"),
        notes="ETF minimum-variance candidate for defensive allocation comparison.",
    ),
    StrategyInventoryEntry(
